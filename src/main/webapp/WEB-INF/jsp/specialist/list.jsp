...
<h3 class="heading_b uk-margin-bottom">专家管理</h3>
        ...
        <div class="md-card">
            <div class="md-card-content" style="height: auto !important;">
                ...
                <div style="height: 40px;">
                    ...
                    <a style="float: right;margin-left: 5px;" class="md-btn md-btn-primary" href="toEdit.do">添加专家</a>
                    ...
                    <div class="uk-width-medium-1-1">
                        <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="750" resizable="true" >
                            ...
                            <kendo:grid-columns>
                                ...
                                <kendo:grid-column title="头像" field="head" width="7%" filterable="false">
                                ...
                                <kendo:grid-column title="专家名字" field="name" width="7%" filterable="false"/>
                                <kendo:grid-column title="电话" field="phone" width="8%" filterable="false"/>
                                <kendo:grid-column title="城市" field="city" width="6%" filterable="false"/>
                                <kendo:grid-column title="附属医院" field="affiliated_hospital" width="12%" filterable="false"/>
                                <kendo:grid-column title="口碑" field="reputation" width="10%" filterable="false"/>
...
<script type="application/javascript">
    ...
    function setShelf(ids,shelf) {
        ...
        UIkit.modal.confirm("确定"+shelfText+"架所选专家？", function () {
            $.post('batchShelf.do', {
                ids: ids,
                shelf: shelf
            }, function (data) {
