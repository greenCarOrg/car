...
<style>
	...
	*{border:0;margin:0;padding:0;}
	...
	.systemlogo{background:url(../images/login/loginlogo.png) no-repeat center;width:100%; height:71px;}
	...
	.loginuser{width:299px; height:48px; background:url(../images/login/loginuser.png) no-repeat; border:none; line-height:48px; padding-left:44px; font-size:14px; color:#90a2bc;}
	...
	.loginbox1{background:url(../images/login/logininfo1.png) no-repeat;}
	.loginbox1 ul li{margin-bottom:16px;}
	.loginbox2{background:url(../images/login/logininfo2.png) no-repeat;}
	.loginbox2 ul li{margin-bottom:16px;}
	.loginbox3{background:url(../images/login/logininfo3.png) no-repeat;}
	.loginbox3 ul li{margin-bottom:16px;}
	.yzm{width:346px; height:46px; background:url(../images/login/yzmbg.png) no-repeat; padding-bottom:5px;}
	...
	.loginbody1{background:url(../images/login/loginbg4.png) no-repeat center center; width:100%; height:585px; overflow:hidden; position:absolute; top:47px;}
	.systemlogo{width:100%; height:71px; text-align:center;}
	.loginbox0{width:810px;margin-top:0px;height:252px;}
</style>

<script src="${path}/assets/js/jquery-1.11.1.min.js"></script>
<script src="${path}/frame/layer/layer.js"></script>
...
<body onkeydown="fn_etr();" style="background-color:#1c77ac; background-image:url(${path}/images/login/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
    ...
    <form action="" method="post" id="dlform">
	    <ul>
	    <li><input name="username" type="text" class="loginuser" placeholder="用户名" maxlength="12" value="admin"/></li>
	    <li><input name="password" type="text" class="loginpwd" placeholder="密码" maxlength="16"  value="1"/></li>
	    <li class="yzm">
	    	...
	    	<img id="code"  alt="验证码" src="${path}/images/login/yzm.jpg" width="100" height="32" class="passcode" title="这个验证码只是给你看的"/>
	    </li>
...
<div class="logintop">    
    <span>欢迎登录${initParam['system-name']}后台</span>
    <ul>
    ...
    <div class="loginbm">${initParam['GGY']}</div>
	<script>
		...
		function fn_dl(tag){
			...
			$.ajax({
				...
				success:function(data){
                    ...
                    data=eval('('+data+')');
                    if (data.status == "1"){
                        location.href = '${path}/console/dashboard.do';
                    }else{
