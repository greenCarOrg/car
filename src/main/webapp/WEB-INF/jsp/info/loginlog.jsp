...
<h3 class="heading_b uk-margin-bottom">用户登录日志管理</h3>
                ...
                <div class="uk-grid">
                    <div class="uk-width-medium-1-1">
                        <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="680" style="border-width:0px;">
                            ...
                            <kendo:grid-column title="用户昵称" field="nickname" sortable="false" filterable="false"  width="90px"/>
                            <kendo:grid-column title="手机号码" field="phone" sortable="false" filterable="false"  width="90px"/>
                            <kendo:grid-column title="注册时间" field="reg_time" sortable="false" filterable="false"  width="90px"/>
                            <kendo:grid-column title="登录时间" field="create_time" sortable="false" filterable="false"  width="90px"/>
                            <kendo:grid-column title="登录地址" field="last_ip" sortable="false" filterable="false"  width="90px"/>
                            ...
                            <kendo:dataSource pageSize="20" serverPaging="true" serverFiltering="true" serverSorting="true">
                                ...
                                <kendo:dataSource-transport>
                                    <kendo:dataSource-transport-read url="loginLogList.do" type="POST" contentType="application/json"/>
