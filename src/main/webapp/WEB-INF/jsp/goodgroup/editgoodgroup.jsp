...
<head>
    ...
    <style>
        ...
        #file{ position:absolute; z-index:0; margin-left:-180px; font-size:60px;opacity:0;filter:alpha(opacity=0); margin-top:-5px;}
    </style>
</head>
<body class="sidebar_main_open sidebar_main_swipe">
<h3 class="heading_b uk-margin-bottom">修改商品分组</h3>

<div class="md-card">
    <div class="md-card-content large-padding" >
        <form:form id="validateSubmitForm" action="updateGoodGroup.do" cssClass="uk-form-stacked" commandName="goodGroup" enctype="multipart/form-data">
            <input name="id"  type="hidden" value="${goodGroup.id}"/>
            <input type="hidden" id="oldparentId" value="${goodGroup.parentId}">
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-2">
                    <div class="parsley-row">
                        ...
                        <input type="radio" name="isparent" <c:if test="${goodGroup.parentId == 0}">checked</c:if> checked="checked" style="width: 20px;height: 20px;" value="1"/>是<label data-text="" style="padding-left: 10%;"/>
                        <input type="radio" name="isparent" <c:if test="${goodGroup.parentId !=0}">checked</c:if> value="0" style="width: 20px;height: 20px;"/>否
                    </div>
                </div>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-2">
                    <div class="parsley-row">
                        ...
                        <span class="icheck-inline">
                            <input type="radio" <c:if test="${goodGroup.state == 1}">checked</c:if> name="state"  value="1" data-md-icheck/>
                            <label  class="inline-label">可用</label>
                        </span>
                        <span class="icheck-inline" style="padding-left: 4%;">
                            <input type="radio" name="state" <c:if test="${goodGroup.state == 0}">checked</c:if> value="0" data-md-icheck/>
                ...
                <div class="uk-width-medium-1-2">
                        ...
                        <span class="icheck-inline">
                            <input type="radio" name="hot" <c:if test="${goodGroup.hot == 1}">checked</c:if> value="1" data-md-icheck/>
                            <label  class="inline-label">推荐</label>
                        </span>
                        <span class="icheck-inline" style="padding-left: 4%;">
                            <input type="radio" name="hot" value="0" <c:if test="${goodGroup.hot == 0}">checked</c:if> data-md-icheck/>
                ...
                <div class="uk-width-medium-1-2">
                    <div class="parsley-row">
                        ...
                        <textarea class="md-input" name="remark" cols="10" rows="3" data-parsley-trigger="keyup" data-parsley-minlength="20"
                                  data-parsley-maxlength="1000" data-parsley-validation-threshold="10">${goodGroup.remark}</textarea>
                    </div>
                </div>
                <div class="uk-width-medium-1-2" style="display: none">
                    ...
                    <div class="parsley-row">
                        <div id="imgPreview" style="width:100px; height:100px;">
                            <c:if test="${empty goodGroup.img}">
                                <img id="imageFile" src="../images/course/course_default.png" style="width:100px;height:100px;">
                            </c:if>
                            <c:if test="${!empty goodGroup.img}">
                                <img id="imageFile" src="${goodGroup.img}" style="width:100px;height:100px;">
                            </c:if>
                        </div>
                    </div>
                </div>
