    ...
    <script>
        ...
        function createChart(){
            ...
            $.each(json.prants, function (date, item) {
                datas.push([item.prantName+ "：￥" +  item.ratioNum.toFixed(2), item.ratio]);
            });
           $('#gradeChat').highcharts({
                ...
                tooltip: {
                    ...
                    formatter: function () {
                        ...
                        return '<b>' + this.point.name + '</b>: ' + json.nodes[this.point.x].ratio + ' %';
                    }
                },
               navigation: {
                   buttonOptions: {
                    ...
                    pie: {
                        ...
                        dataLabels: {
                            ...
                            formatter: function () {
                                ...
                                if(json.nodes[this.point.x].ratioNum < 0){
                                    return '<b>' + this.point.name + '</b>: ' + -json.nodes[this.point.x].ratio + ' %';
                                }
                                return '<b>' + this.point.name + '</b>: ' + json.nodes[this.point.x].ratio + ' %';
                            }
            ...
            if(null != json.nodes){
                for(var i=0;i<json.nodes.length;i++){
                    if(json.nodes[i].ratioNum < 0){
                        json.nodes[i].ratio = -json.nodes[i].ratio;
                    }
                }
...
<div class="md-card-content" id="content" style="height: 370px;">
    <div id="gradeChat" class="mGraph" style="min-width: 300px; height: 400px; margin: 0 auto"></div>
