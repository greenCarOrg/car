...
<head>
    ...
    <script>
        ...
        function createChart(){
            ...
            resourcesSummaryChart2(json);
        }

        function resourcesSummaryChart2(json){
            var xcategories = json.roomName;
            var roomCount = json.roomCount;
            var startDate = json.startDate;
            var endDate = json.endDate;
            $('#resourcesSummaryChart2').highcharts({
                chart: {
...
<div class="md-card-content" id="content" style="height: 400px;">
    <div id="resourcesSummaryChart2" class="mGraph" style="width: 100%; height: 360px; margin: 0 auto;
