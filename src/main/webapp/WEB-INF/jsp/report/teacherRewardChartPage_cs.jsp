...
<head>
    ...
    <script>
        ...
        function createChart(){
            ...
            var texts = ['按学科统计课酬分布','按年级统计课酬分布','按老师统计课酬分布'];
            ...
            for(var i=0;i<divIds.length;i++){
                ...
                $('#'+divIds[i]).highcharts({
                    ...
                    tooltip: {
                        ...
                        formatter: function () {
                            return '<b>' + this.point.name +'\<br\>课酬:'+datas[value[this.series.name]].valueAry[this.point.x]+'\<br\>占比:'+this.point.percentage.toFixed(2)+'%';
                        }
                    },
                    legend:{
                        layout: 'vertical',
