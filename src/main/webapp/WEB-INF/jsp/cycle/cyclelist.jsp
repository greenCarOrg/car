...
<h3 class="heading_b uk-margin-bottom">周期管理</h3>
        ...
        <div class="md-card">
            <div class="md-card-content" style="height: auto !important;">
                ...
                <div style="padding :0 30px 10px 0;text-align: right">
                    <a class="md-btn md-btn-primary" href="toAddCycle.do">新增</a>
                ...
                <div class="uk-grid">
                    ...
                    <kendo:grid name="grid" pageable="true" sortable="true" filterable="true" selectable="true" height="680" style="border-width:0px;">
                        ...
                        <kendo:grid-column title="周期编号" field="level" sortable="false" filterable="false"  width="90px"/>
                        <kendo:grid-column title="内容" field="remark" sortable="false" filterable="false"  width="90px"/>
                        <kendo:grid-column title="创建时间" field="create_time" sortable="false" filterable="false"  width="90px"/>
                        <kendo:grid-column title="创建人" field="user_name" sortable="false" filterable="false" width="90px"/>
                                ...
                                <kendo:grid-column-template>
                                    <script>
                                        function template(options) {
                                            var html="<img style='height: 190px;' onclick='showImg(this)' src="+'http://7xjew0.com2.z0.glb.qiniucdn.com/'+options.img+">";
                                            return html;
                                        }
                                    </script>
                                </kendo:grid-column-template>
                                        ...
                                        <kendo:grid-column-commandItem-click>
                                            <script>
                                                function enabledState(e) {
                                                    ...
                                                    UIkit.modal.confirm("审核"+ (state ? "启用" : "停用") +"吗?", function(){
                                                        $.get('enabledState.do', {
                                                            id: dataItem.id,
                                                            state: !state
                                                        }, function (data) {
                        ...
                        <kendo:dataSource pageSize="5" serverPaging="true" serverFiltering="true" serverSorting="true">
                            ...
                            <kendo:dataSource-transport>
                                <kendo:dataSource-transport-read url="cycleList.do" type="POST" contentType="application/json"/>
...
<script type="application/javascript">
    ...
    function editItem() {
        ...
        if (dataItem) {
            window.location.href = "toEditCycle.do?id=" + dataItem.id;
        }
    }
</script>
</body>
