...
public class HttpClient {
	...
	public static String execute(String reqUrl, Map<String,String> reqParams, String method, String contentType, String charset) throws Exception {
	...
	public static String execute(String reqUrl, String content, String method, String contentType) throws Exception {
        ...
        conn.setReadTimeout(1000); // 缓存的最长时间
	...
	public static void main(String[] args) {
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><request><mobileInfo><imei>861836010013535</imei><mac>68:9c:5e:b8:78:67</mac><version>1.0.0.0</version><model>小宇宙×1</model><screenSize>720X1280</screenSize><platForm>4.2.1</platForm><os>Android</os></mobileInfo><channelId>-1</channelId><appId>101</appId><pid>555548</pid><digest>940765010d81c0ef77eb7fa4a319eb1e</digest></request>";
