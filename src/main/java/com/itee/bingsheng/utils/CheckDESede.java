...
public class CheckDESede {
    ...
    public static String EncryptCode(String strTobeEnCrypted, String sKey,
        ...
        String retStr = null;
        byte[] retByte = null;
        byte[] sorData = strTobeEnCrypted.getBytes(CHARSET);
    ...
    public static String DecryptCode(String strTobeDeCrypted, String sKey,
        ...
        retStr = new String(retByte, CHARSET);
        return retStr;
    }

    public static void main(String[] args) throws Exception {
        System.out.println(CheckDESede.DecryptCode("eCR+/dePkQXhzdrJnaIFouRxplUYjL4DP88LHUq8otggOTS4xUTSZRrKs1cD4w7E", "LslWNDmTHerk", "YscWtaSn"));
