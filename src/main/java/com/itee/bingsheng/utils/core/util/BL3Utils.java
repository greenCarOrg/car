...
public class BL3Utils {
	...
	public static Map<String,Object> treeMapToMap(Map<String,Object> params,Map<String,Object> resultMap) {
		for(Map.Entry<String,Object> entry:params.entrySet()){
		    if (entry.getValue() instanceof Map) {
		    	treeMapToMap((Map<String, Object>) entry.getValue(),resultMap);
		    }else{
